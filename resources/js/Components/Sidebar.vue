    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li v-if="$page.props.auth?.user?.role === 'admin'" class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/users') }">
                    <Link href="/admin/users" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-person-gear icon icon-xs me-2" viewBox="0 0 16 16">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/lessons') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __("Lessons") }}</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/classrooms') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __("Classrooms") }}</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/rooms') }">
                    <Link href="/admin/rooms" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-door-open icon icon-xs me-2" viewBox="0 0 16 16">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/exams') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __("Exams") }}</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/question-bank') }">
                    <Link href="/admin/question-bank" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-database icon icon-xs me-2" viewBox="0 0 16 16">
                        ...
                        <span class="sidebar-text">{{ __("Question Bank") }}</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/exam_sessions') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __("Exam Sessions") }}</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/essay-grading') }">
                    <Link href="/admin/essay-grading" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-pencil-square icon icon-xs me-2" viewBox="0 0 16 16">
                        ...
                        <span class="sidebar-text">{{ __("Essay Grading") }}</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/monitor') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">{{ __("Live Monitor") }}</span>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/violation-logs') }">
                    ...
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-shield-exclamation icon icon-xs me-2" viewBox="0 0 16 16">
                        ...
                        <span class="sidebar-text">{{ __("Violation Logs") }}</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/analytics') }">
                    <Link href="/admin/analytics" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                class="bi bi-bar-chart-line icon icon-xs me-2" viewBox="0 0 16 16">
                                <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/>
                            </svg>
                        </span>
                        <span class="sidebar-text">{{ __("Analytics") }}</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/ai-generator') }">
                    <Link href="/admin/ai-generator" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-robot icon icon-xs me-2" viewBox="0 0 16 16">
                        ...
                        <span class="sidebar-text">{{ __("AI Generator") }}</span>
                    </span>
                    </Link>
                </li>

                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/plagiarism') }">
                    <Link href="/admin/plagiarism" class="nav-link d-flex justify-content-between">
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-search icon icon-xs me-2" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                            </svg>
                        </span>
                        <span class="sidebar-text">{{ __("Plagiarism") }}</span>
                    </span>
                    </Link>
                </li>
