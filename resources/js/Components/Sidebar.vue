            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/question-categories') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">Kategori Soal</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/essay-grading') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">Penilaian Essay</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/violation-logs') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">Log Pelanggaran</span>
                    </span>
                    </Link>
                </li>
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/ai-generator') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">AI Generator</span>
                    </span>
                    </Link>
                </li>
