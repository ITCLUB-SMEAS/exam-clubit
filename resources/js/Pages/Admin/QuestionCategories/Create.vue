<template>
    <Head>
        <title>Tambah Kategori - Aplikasi Ujian Online</title>
    </Head>
...
export default {
    ...
    props: { lessons: Array, errors: Object },
    setup() {
        const form = useForm({ name: '', description: '', lesson_id: '' });
        const submit = () => form.post('/admin/question-categories');
        return { form, submit };
    }
}
</script>
