<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link :href="`/admin/exams/${exam.id}`" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i class="fas fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fas fa-question-circle"></i> Edit Soal Ujian</h5>
                        <hr>
                                ...
                                <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                    <tbody>
                                        ...
                                        <tr v-if="form.question_type === 'short_answer'">
                                            <td class="fw-bold">Jawaban Benar</td>
                                            <td>
                                                <input type="text" class="form-control" v-model="form.correct_answers_text" placeholder="pisahkan dengan koma" />
...
export default {
    ...
    setup(props) {
        const form = reactive({
            ...
            correct_answers_text: Array.isArray(props.question.correct_answers) ? props.question.correct_answers.join(', ') : '',
            matching_pairs: props.question.matching_pairs || [{ left: '', right: '' }, { left: '', right: '' }],
        });
        ...
        const submit = () => {
            ...
            router.put(`/admin/exams/${props.exam.id}/questions/${props.question.id}/update`, payload, {
                onSuccess: () => {
                    Swal.fire({ title: 'Success!', text: 'Soal Ujian Berhasil Diupdate!', icon: 'success', showConfirmButton: false, timer: 2000 });
                },
            });
        };
