            ...
            <div class="col-12">
                <div class="card border-0 shadow">
                    <div class="card-header bg-white">
                        <h5 class="mb-0"><i class="fas fa-tv me-2"></i>Monitor Ujian Real-time</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div v-for="session in activeSessions" :key="session.id" class="col-md-6 col-lg-4 mb-4">
                                <div class="card h-100 border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1"><i class="fas fa-users me-2"></i>{{ session.exam.classroom?.title || '-' }}</p>
                                        <p class="mb-1"><i class="fas fa-clock me-2"></i>{{ formatTime(session.start_time) }} - {{ formatTime(session.end_time) }}</p>
                                        <div class="mt-3">
                                            <span class="badge bg-success me-1"><i class="fas fa-circle"></i> Live</span>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-white">
                                        <Link :href="`/admin/monitor/${session.id}`" class="btn btn-primary btn-sm w-100">
